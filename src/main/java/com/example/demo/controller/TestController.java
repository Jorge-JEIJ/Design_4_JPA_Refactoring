...
public class TestController {
    ...
    /*
    //EJERCICIO 2 METODO PARA PROBAR EXCEPCIONES DURANTE TRANSACCION
    @GetMapping("/ej2")
    public List<UserDTO> getUsersEj2() {
        return userService.testTransaction();
    }

    //EJERCICIO 3 METODO PARA PROBAR EXCEPCIONES DURANTE TRANSACCION
    @GetMapping("/ej3")
    public List<UserDTO> getUsersEj3() throws Exception {
        List<UserDTO> users = new ArrayList<>();
        users.addAll( userService.testTransactionEj3() );
        return users;
    }

    //EJERCICIO 4
    @GetMapping("/ej4")
    public UserDTO getUsersEj4() {
        return userService.testTransactionEj4();
    }
    */
}
